...
const STRINGS = {
  'en-US': {
    ...
    'settings.uninstallDesc': 'Remove Asher from the game folder and restore original files where possible. The manager app stays so you can reinstall.',
    ...
    'uninstall.help': 'Remove Asher runtime files and restore the original game executable. The manager under Asher/Asher.App is kept for reinstall.',
    'uninstall.warning': 'Do not close the application during uninstall.',
    'uninstall.confirm': 'Remove Asher from this game installation? The manager app will remain so you can install again.',
    ...
    'uninstall.success': 'Uninstallation completed. You can install Asher again from this app.',
    ...
    'action.uninstallSuccess': 'Uninstallation completed. You can install again from this app.',
  ...
  'pt-BR': {
    ...
    'settings.uninstallDesc': 'Remover o Asher da pasta do jogo e restaurar os arquivos originais quando possível. O gerenciador permanece para reinstalar.',
    ...
    'uninstall.help': 'Remover os arquivos de runtime do Asher e restaurar o executável original. O gerenciador em Asher/Asher.App é mantido para reinstalar.',
    'uninstall.warning': 'Não feche o aplicativo durante a desinstalação.',
    'uninstall.confirm': 'Remover o Asher desta instalação? O gerenciador permanece para você instalar novamente.',
    ...
    'uninstall.success': 'Desinstalação concluída. Você pode instalar o Asher novamente por este aplicativo.',
  ...
  'es-ES': {
    ...
    'settings.uninstall': 'Desinstalar',
    'settings.uninstallDesc': 'Eliminar Asher de la carpeta del juego y restaurar archivos originales cuando sea posible. El gestor permanece para reinstalar.',
    'settings.uninstallAction': 'Desinstalar Asher',
    ...
    'uninstall.title': 'Desinstalando Asher',
    'uninstall.help': 'Eliminar los archivos de runtime de Asher y restaurar el ejecutable original. El gestor en Asher/Asher.App se conserva para reinstalar.',
    'uninstall.warning': 'No cierres la aplicación durante la desinstalación.',
    'uninstall.confirm': '¿Eliminar Asher de esta instalación? El gestor permanecerá para que puedas instalar de nuevo.',
    'uninstall.action': 'Desinstalar',
    'uninstall.cancel': 'Cancelar',
    'uninstall.starting': 'Iniciando desinstalación...',
    'uninstall.inProgress': 'Desinstalando...',
    'uninstall.cancelling': 'Cancelando desinstalación...',
    'uninstall.success': 'Desinstalación completada. Puedes instalar Asher de nuevo desde esta aplicación.',
    'uninstall.continue': 'Continuar',
