...
const STRINGS = {
  'en-US': {
    ...
    'uninstall.help': 'Remove Asher and restore original game files where possible. Without this app, use Asher/Uninstall-Asher.cmd in the game folder.',
  ...
  'pt-BR': {
    ...
    'uninstall.help': 'Remover o Asher e restaurar os arquivos originais do jogo quando possível. Sem este app, use Asher/Uninstall-Asher.cmd na pasta do jogo.',
  ...
  'es-ES': {
    ...
    'uninstall.title': 'Desinstalando Asher',
    'uninstall.help': 'Eliminar Asher y restaurar los archivos originales del juego cuando sea posible. Sin esta app, usa Asher/Uninstall-Asher.cmd en la carpeta del juego.',
